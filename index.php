	...
	<body>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<header>
						<h1>Get informed about future events</h1>
					</header>
					...
					<div class="flex flex-2">
						<article>
							<div class="image round">
								<img src="/App/images/pic01.jpg" alt="Pic 01" />
							</div>
							<header>
						...
						<article>
							<div class="image round">
								<img src="/App/images/pic02.jpg" alt="Pic 02" />
							</div>
							<header>
		...
		<!-- Scripts -->
			...
			<script src="App/js/skel.min.js"></script>
